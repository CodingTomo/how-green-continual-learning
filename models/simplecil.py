...
class Learner(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        task_emission_tracker = EmissionsTracker(log_level="critical", project_name="SimpleCil_Task_{}".format(self._cur_task), output_file=self.outpath+"SimpleCil_per_task_emissions.csv")
    ...
    def inference_gpu_time(self, model_name, outpath):
        ...
        with torch.no_grad():
            inference_tracker = EmissionsTracker(log_level="critical", project_name="SimpleCil_inference_Task_{}".format(self._cur_task), output_file=self.outpath+"SimpleCil_per_task_inference_emissions.csv")
