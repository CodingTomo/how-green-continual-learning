...
class iImageNetR(iData):
    ...
    def download_data(self):
        ...
        if train_dir == "" or test_dir == "":
            raise ValueError("Please specify the path to the ImageNet-R dataset")
...
class iDomainNet(iData):
    ...
    def download_data(self):
        ...
        if train_test_dir == "":
            raise ValueError("Please specify the path to the DomainNet dataset")
    ...
    def get_train_val_images_domainnet(self, data_path):
        train_annotations = open(os.path.join(data_path, "DomainNet",  "dn_train.txt"), "r")
        test_annotations = open(os.path.join(data_path, "DomainNet",  "dn_test.txt"), "r")
